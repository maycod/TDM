...
v_error_message VARCHAR2(50) := 'Error, Process wil be aborted';
    ...
    BEGIN
        OPEN c_resultados FOR
        SELECT USR.ID_USERUARIO, USR.CVE_USUARIO,USR.ID_TIPO_USUARIO,PRO.DESC_TIPO_USUARIO ,USR.FECHA_CREACION
        FROM DMTDM.TDM_CAT_USUARIO USR, ADMTDM.TDM_CAT_TIPO_USUARIO PRO
        WHERE USR.INDICADOR = 1 AND USR.ID_TIPO_USUARIO = PRO.ID_TIPO_USUARIO
    ...
    BEGIN
        ...
        SELECT COALESCE(MAX(ID_USUARIO),0)+1 INTO v_id_next_val FROM ADMTDM.TDM_CAT_USUARIO;
        MERGE INTO ADMTDM.TDM_CAT_USUARIO USR
        USING
   ...
   -- Agrega nuevo estudiante
    ...
    BEGIN
        ...
        FROM ADMTDM.TDM_CAT_USUARIO USR, ADMTDM.TDM_CAT_TIPO_USUARIO PRO
        WHERE INDICADOR = 1 AND USR.ID_TIPO_USUARIO = PRO.ID_TIPO_USUARIO

...
CREATE TABLE ADMTDM.TDM_CAT_TIPO_USUARIO (
...
CREATE UNIQUE INDEX ADMTDM.XPKTDM_CAT_TIPO_USUARIO ON ADMTDM.TDM_CAT_TIPO_USUARIO (ID_TIPO_USUARIO ASC)
TABLESPACE TS_TDM_INDEX storage(initial 512K next 512K);

ALTER TABLE ADMTDM.TDM_CAT_TIPO_USUARIO
    ADD CONSTRAINT XPKTDM_CAT_TIPO_USUARIO PRIMARY KEY (ID_TIPO_USUARIO);

GRANT SELECT, INSERT, UPDATE ON ADMTDM.TDM_CAT_TIPO_USUARIO TO USRTDM;
...
CREATE TABLE ADMTDM.TDM_CAT_TAREA (
    ...
    CVE_TARTEA VARCHAR2(30) NOT NULL,
